...
impl SolvePart1 for Problem {
    ...
    fn solve_part_one(&mut self, parsed_output: ParsedOutput) -> String {
        solve_part_one(self, parsed_output)
    }
}

pub fn solve_part_one(problem: &Problem, (mut parsed_data, index_of_0): ParsedOutput) -> String {
    let number_of_mixes: u8 = problem.number_of_mixes;
    let multiplication_factor: i64 = problem.multiplication_factor;
    ...
    for iter_count in 0..(arr_size * number_of_mixes as usize) {
        ...
        let mut movement = parsed_data[index as usize].data * (multiplication_factor % max_index);
        ...
        while index != new_index {
            ...
            movement_tracking_array[parsed_data[index as usize].index as usize] -= per_itr_movement;
